...
class DBHandler():
    ...
    def create_default_tables(self):
        ...
        CREATE TABLE IF NOT EXISTS players_static (id INTEGER PRIMARY KEY, first_name TEXT, last_name TEXT, web_name TEXT, team INTEGER, element_type INTEGER, 
                                                ...
                                                news TEXT, news_added DATETIME, now_cost INTEGER, own_goals INTEGER,
        ...
        CREATE TABLE IF NOT EXISTS events_static (id INTEGER PRIMARY KEY, average_entry_score INTEGER, data_checked, deadline_time TEXT, finished TEXT, highest_score INTEGER, 
